...
public abstract class BaseLeaderGroup<M extends BaseLeaderGroup<M>> extends JbootModel<M> implements IBean {
	...
	public java.lang.String getDeputy() {
		return getStr("deputy");
	}

	public void setCrew(java.lang.String crew) {
		set("crew", crew);
	}
	
	public java.lang.String getCrew() {
		return getStr("crew");
	}
