...
public abstract class BaseSiteSurveyExpertAdvice<M extends BaseSiteSurveyExpertAdvice<M>> extends JbootModel<M> implements IBean {
	...
	public void setResolving(java.lang.String resolving) {
		set("resolving", resolving);
	}
	
	public java.lang.String getResolving() {
		return getStr("resolving");
	}

	public void setOtherComments(java.lang.String otherComments) {
		set("otherComments", otherComments);
	}
	
	public java.lang.String getOtherComments() {
		return getStr("otherComments");
	}
