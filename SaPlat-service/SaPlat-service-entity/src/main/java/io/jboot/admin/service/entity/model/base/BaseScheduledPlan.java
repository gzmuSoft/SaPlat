...
public abstract class BaseScheduledPlan<M extends BaseScheduledPlan<M>> extends JbootModel<M> implements IBean {
	...
	public void setEvaSchemeID(java.lang.Long evaSchemeID) {
		set("evaSchemeID", evaSchemeID);
	}
	
	public java.lang.Long getEvaSchemeID() {
		return getLong("evaSchemeID");
	}
