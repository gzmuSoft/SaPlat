...
public abstract class BaseRole1<M extends BaseRole1<M>> extends JbootModel<M> implements IBean {
	...
	public void setProjectNo(java.lang.Integer projectNo) {
		set("projectNo", projectNo);
	}
	
	public java.lang.Integer getProjectNo() {
		return getInt("projectNo");
	}
