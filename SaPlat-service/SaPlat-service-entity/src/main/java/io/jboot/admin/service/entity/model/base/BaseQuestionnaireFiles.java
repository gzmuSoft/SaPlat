...
public abstract class BaseQuestionnaireFiles<M extends BaseQuestionnaireFiles<M>> extends JbootModel<M> implements IBean {
	...
	public java.lang.Long getQuestionnaireId() {
		return getLong("questionnaire_id");
	}
