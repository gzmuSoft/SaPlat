...
public abstract class BaseInformationFill<M extends BaseInformationFill<M>> extends JbootModel<M> implements IBean {
	...
	public void setHtmlName(java.lang.String htmlName) {
		set("htmlName", htmlName);
	}
	
	public java.lang.String getHtmlName() {
		return getStr("htmlName");
	}
